...
- [Deep Audit 2026-08-06](deep-audit-2026-08-06.md) - two full runtime passes covering progression/XP math, stat ownership, AI instance state, persistence locking, and lifecycle hygiene. AUD-022 to AUD-039 fixed, pending Unity compile/playtest verification.
